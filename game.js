...
class BrainstormGame {
  ...
  setupUi() {
    ...
    this.replayButton = rect(WIDTH / 2 - 130, HEIGHT / 2 + 46, 260, 50);
    this.quitButton = rect(WIDTH / 2 - 130, HEIGHT / 2 + 108, 260, 50);
  ...
  drawGameOverOverlay() {
    ...
    const panel = rect(WIDTH / 2 - 220, HEIGHT / 2 - 175, 440, 350);
    ...
    drawCenteredText(ctx, String(this.score), WIDTH / 2, panel.y + 184, "700 46px Segoe UI, Arial", COLORS.black);
